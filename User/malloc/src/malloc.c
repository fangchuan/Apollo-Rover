...
*********************************************************************************************************
*/
static void mymemset(void *s,u8 c,u32 count);	//设置内存
static void mymemcpy(void *des,void *src,u32 n);//复制内存     
static u32 my_mem_malloc(u8 memx,u32 size);	//内存分配(内部调用)
static u8 my_mem_free(u8 memx,u32 offset);		//内存释放(内部调用)
...
*	返 回 值: 返回值:0,释放成功;1,释放失败; 2,偏移地址错误
*********************************************************************************************************
*/
...
*	函 数 名: myrealloc
*	功能说明: 重新分配内存(外部调用)
*	形    参: memx:所属内存块; *ptr:旧内存首地址; size:内存大小(字节)
*	返 回 值: 新分配到的内存首地址.
*********************************************************************************************************
*/
